...
typedef enum MAV_DATA_STREAM
{
	...
	MAV_DATA_STREAM_DATE_GCS=8, /* Dependent on the autopilot | */
...
#include "./mavlink_msg_data_msg.h"
#include "./mavlink_msg_drone_angle.h"
...
#include "./mavlink_msg_yyz_calibration.h"
#include "./mavlink_msg_data_add_msg.h"
