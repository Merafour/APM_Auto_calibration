...
typedef struct __mavlink_rc_channels_override_t {
 ...
 uint16_t chan10_raw; /*< RC channel 10 value, in microseconds. A value of UINT16_MAX means to ignore this field.*/
 uint8_t target_system; /*< System ID*/
 uint8_t target_component; /*< Component ID*/
}) mavlink_rc_channels_override_t;

#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_LEN 22
#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_MIN_LEN 22
#define MAVLINK_MSG_ID_70_LEN 22
#define MAVLINK_MSG_ID_70_MIN_LEN 22

#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_CRC 72
#define MAVLINK_MSG_ID_70_CRC 72
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_OVERRIDE { \
	...
	{  { "chan1_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_rc_channels_override_t, chan1_raw) }, \
         ...
         { "chan9_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 16, offsetof(mavlink_rc_channels_override_t, chan9_raw) }, \
         { "chan10_raw", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_rc_channels_override_t, chan10_raw) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_rc_channels_override_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_rc_channels_override_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_OVERRIDE { \
 ...
 * @param chan10_raw RC channel 10 value, in microseconds. A value of UINT16_MAX means to ignore this field.
...
{
	return mavlink_msg_rc_channels_override_pack(system_id, component_id, msg, rc_channels_override->target_system, rc_channels_override->target_component, rc_channels_override->chan1_raw, rc_channels_override->chan2_raw, rc_channels_override->chan3_raw, rc_channels_override->chan4_raw, rc_channels_override->chan5_raw, rc_channels_override->chan6_raw, rc_channels_override->chan7_raw, rc_channels_override->chan8_raw, rc_channels_override->chan9_raw, rc_channels_override->chan10_raw);
}
 ...
 *
 * @return RC channel 10 value, in microseconds. A value of UINT16_MAX means to ignore this field.
 */
